...
export class WeeklyComponent implements OnInit {
  ...
  constructor(private lectureService:LectureService, private labService:LabService, private speakerService:SpeakerService, private eventService:EventService) {}
